        ...
        if (!reset_n) begin
            ...
            case (STATUS_IN) 
                3'd0: begin 
                    ...
                    line1_buffer[6]<="p"; line1_buffer[7]<="a"; line1_buffer[8]<="s"; line1_buffer[9]<="s"; 
                end
                3'd1: begin 
                    line1_buffer[0]<="U"; line1_buffer[1]<="n"; line1_buffer[2]<="l"; 
                    line1_buffer[3]<="o"; line1_buffer[4]<="c"; line1_buffer[5]<="k"; 
                end
                3'd2: begin 
                    line1_buffer[0]<="L"; line1_buffer[1]<="o"; line1_buffer[2]<="c"; line1_buffer[3]<="k"; 
                end
                3'd3: begin 
                    line1_buffer[0]<="N"; line1_buffer[1]<="e"; line1_buffer[2]<="w"; line1_buffer[3]<=" "; 
                    line1_buffer[4]<="p"; line1_buffer[5]<="a"; line1_buffer[6]<="s"; line1_buffer[7]<="s"; 
                end
                3'd4: begin 
                    line1_buffer[0]<="W"; line1_buffer[1]<="r"; line1_buffer[2]<="o"; line1_buffer[3]<="n"; line1_buffer[4]<="g"; 
                end
                default: begin 
                    line1_buffer[0]<="I"; line1_buffer[1]<="d"; line1_buffer[2]<="l"; line1_buffer[3]<="e"; 
                end
            endcase
        end
    end
